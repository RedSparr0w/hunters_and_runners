...
execute unless entity @a[gamemode=survival,team=runners] run title @a title {"text":"Hunters Win!","color":"aqua"}
execute unless entity @a[gamemode=survival,team=runners] as @p run function hunters_and_runners:information
