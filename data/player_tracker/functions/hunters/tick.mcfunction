execute as @e[team=hunters,nbt={Dimension:0,Inventory:[{tag:{compass_type:"tracking_device"}}]}] at @s unless entity @e[team=runners,nbt={Dimension:0}] run function player_tracker:hunters/not_found
execute as @e[team=hunters,nbt={Dimension:-1,Inventory:[{tag:{compass_type:"tracking_device"}}]}] at @s unless entity @e[team=runners,nbt={Dimension:-1}] run function player_tracker:hunters/not_found
execute as @e[team=hunters,nbt={Dimension:1,Inventory:[{tag:{compass_type:"tracking_device"}}]}] at @s unless entity @e[team=runners,nbt={Dimension:1}] run function player_tracker:hunters/not_found
