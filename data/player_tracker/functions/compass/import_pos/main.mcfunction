...
data modify storage import:pos Items[] set from entity @s SelectedItem{tag:{compass_type:"tracking_device"}}
data modify storage import:pos Items[] set from entity @s Inventory[{Slot:-106b,tag:{compass_type:"tracking_device"}}]
data modify storage import:pos Items[] set from entity @s Inventory[{Slot:-8b,tag:{compass_type:"tracking_device"}}]
...
execute store result storage import:pos Items[].tag.LodestonePos.X int 1 run scoreboard players get @e[team=runners,limit=1] xpos
execute store result storage import:pos Items[].tag.LodestonePos.Y int 1 run scoreboard players get @e[team=runners,limit=1] ypos
execute store result storage import:pos Items[].tag.LodestonePos.Z int 1 run scoreboard players get @e[team=runners,limit=1] zpos
