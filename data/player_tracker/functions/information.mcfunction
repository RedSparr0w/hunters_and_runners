...
execute if score hunters_should_glow hnr.settings matches 1 run tellraw @s [{"text":"Hunters should glow: ","hoverEvent":{"action":"show_text","value":{"text":"Apply glow effect to Hunters when within 20 blocks of a Runner"}}},{"text":"[true]","color":"aqua","clickEvent":{"action":"run_command","value":"/function player_tracker:settings/hunters_should_glow"},"hoverEvent":{"action":"show_text","value":{"text":"Toggle setting"}}}]
execute if score hunters_should_glow hnr.settings matches 0 run tellraw @s [{"text":"Hunters should glow: ","hoverEvent":{"action":"show_text","value":{"text":"Apply glow effect to Hunters when within 20 blocks of a Runner"}}},{"text":"[false]","color":"red","clickEvent":{"action":"run_command","value":"/function player_tracker:settings/hunters_should_glow"},"hoverEvent":{"action":"show_text","value":{"text":"Toggle setting"}}}]
execute if score runners_should_glow hnr.settings matches 1 run tellraw @s [{"text":"Runners should glow: ","hoverEvent":{"action":"show_text","value":{"text":"Apply glow effect to Runners when within 20 blocks of a Hunter"}}},{"text":"[true]","color":"aqua","clickEvent":{"action":"run_command","value":"/function player_tracker:settings/runners_should_glow"},"hoverEvent":{"action":"show_text","value":{"text":"Toggle setting"}}}]
execute if score runners_should_glow hnr.settings matches 0 run tellraw @s [{"text":"Runners should glow: ","hoverEvent":{"action":"show_text","value":{"text":"Apply glow effect to Runners when within 20 blocks of a Hunter"}}},{"text":"[false]","color":"red","clickEvent":{"action":"run_command","value":"/function player_tracker:settings/runners_should_glow"},"hoverEvent":{"action":"show_text","value":{"text":"Toggle setting"}}}]
